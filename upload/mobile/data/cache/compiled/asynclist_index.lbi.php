  ...
  <dl>
    <dd class="dd-price">
      <span class="pull-left">
        <strong>
            <b class="ect-colored">
              <?php if ($this->_var['hot_goods']['promote_price']): ?><?php echo $this->_var['hot_goods']['promote_price']; ?>
              <?php else: ?><?php echo $this->_var['hot_goods']['shop_price']; ?>
              <?php endif; ?>
            </b>
        </strong>
        <small class="ect-margin-lr">
          <del><?php echo $this->_var['hot_goods']['market_price']; ?></del>
        </small>
      </span>
    ...
    <dd class="dd-num">
      <span class="pull-left<?php if ($this->_var['hot_goods']['mysc'] != 0): ?> ect-colory<?php endif; ?>">
        <i class="fa<?php if ($this->_var['hot_goods']['mysc'] != 0): ?> fa-heart<?php else: ?> fa-heart-o<?php endif; ?>"></i>
         <strong class="ect-colored"><?php echo $this->_var['hot_goods']['sc']; ?></strong><?php echo $this->_var['lang']['like_num']; ?>
      </span>
      <span class="pull-right"><?php echo $this->_var['lang']['sort_sales']; ?>
      <strong class="ect-colored"><?php echo $this->_var['hot_goods']['sales_count']; ?></strong><?php echo $this->_var['lang']['piece']; ?>
      </span>
    </dd>
  </dl>
<?php endif; ?> 
