...
?> 
  ...
  <div class="goods-info ect-padding-tb"> 
    ...
    <section class="ect-margin-tb ect-margin-lr">
      ...
      <p>
        <?php echo $this->_var['lang']['market_price']; ?>
        <small> <del><?php echo $this->_var['goods']['market_price']; ?></del></small>
      </p>
      <?php endif; ?>
      <p>
...
?>
  ...
  <div class="goods-related ect-padding-lr ect-padding-tb">
    ...
    <div id="picScroll" class="picScroll">
      ...
      <div class="bd">
        <ul>
          <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_32884700_1496851976');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_32884700_1496851976']):
        $this->_foreach['goods']['iteration']++;
?>
          <li><a href="<?php echo $this->_var['goods_0_32884700_1496851976']['url']; ?>"><img _src="<?php echo $this->_var['goods_0_32884700_1496851976']['goods_thumb']; ?>" src="<?php echo $this->_var['goods_0_32884700_1496851976']['goods_thumb']; ?>" /></a>
            <p class="ect-color"> 
              <?php if ($this->_var['goods_0_32884700_1496851976']['promote_price']): ?> 
              <?php echo $this->_var['goods_0_32884700_1496851976']['formated_promote_price']; ?>
              <?php else: ?> 
              <?php echo $this->_var['goods_0_32884700_1496851976']['shop_price']; ?>
              <?php endif; ?> 
            </p>
            <p class="text-left"><?php echo $this->_var['goods_0_32884700_1496851976']['short_name']; ?></p>
          </li>
