...
<head>
	...
	<link rel="stylesheet" href="assets/css/custom.css">
 	<!-- <link rel = "import" href = "dashboard-1-left.html"/> -->
	<script src="assets/js/jquery-1.11.1.min.js"></script>
<!-- 	<script>
    var post = document.querySelector("link[rel = 'import']").import;
    var con = post.querySelector("div");
    document.querySelector("#leftmenudiv").appendChild(con.cloneNode(true));

    var clone = document.importNode(con,true)
    document.querySelector("#leftmenudiv").appendChild(clone)
</script> -->
...
<body class="page-body">
	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="sidebar-menu toggle-others fixed" id="leftmenudiv">
			
			<!-- <iframe SRC="dashboard-1-left.html" width="450" height="400" frameborder="0" scrolling="no">  -->
